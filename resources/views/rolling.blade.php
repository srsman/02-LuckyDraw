...
.main_bg{background:url({{ asset('img/main_bg_bak.jpg')}}) top center no-repeat;height:1000px;}
...
.btn{background:url({{asset('img/btn_start.png')}}) 0px 0px no-repeat;width:264px;height:89px;position:absolute;left:50%;bottom:50px;margin-left:-132px;cursor:pointer;clear:both;}
