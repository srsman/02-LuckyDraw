              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="form-group">
                    {{-- <label for="inputPrizeName" class="col-lg-2 control-label">奖品名称</label> --}}
                    <div class="col-lg-3">
                      <input type="text" class="form-control" id="inputPrizeName{{$key+1}}" name="inputPrizeName{{$key+1}}" placeholder="奖品名称" value="{{ $thing['name'] }}" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-2">
                      <input type="number" class="form-control" id="inputAmount{{$key+1}}" name="inputAmount{{$key+1}}" value="{{$thing['amount']}}" placeholder="奖品数量" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    {{-- <label for="inputNumber" class="col-lg-2 control-label">权重</label> --}}
                    <div class="col-lg-1">
                      <input type="number" class="form-control" id="inputPowerNumber{{$key+1}}" name="inputPowerNumber{{$key+1}}" value="{{$thing['weight']}}" placeholder="权重" required>
                    </div>
                  </div>
